# --------------------------------
YOUR_Email_For_TAkeAdmin_Exploit = 'itstaha0000@gmail.com'  # Edit this line with your email Address
r = '\033[31m'
g = '\033[32m'  # MargBot Version 4.0 [2/24/2020]
y = '\033[33m'  # Note! : We don't Accept any responsibility for any illegal usage.
b = '\033[34m'  # This tool is for Penetration Testing
m = '\033[35m'  #
c = '\033[36m'
w = '\033[37m'  # [github.com/M4rgs]
# --------------------------------
...
def options():
    option = '''
    {}USAGE {}
      [{}python margus.py {}list.txt{}
       python margus.py {}Dork{}{}]
