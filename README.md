### MargBot V4 | Auto Exploiter With 500+ Exploit 2000+ Shell 

MargBot is an auto exploit tool to facilitate the penetration of one or many websites (Wordpress, Joomla, Drupal, Magento, Opencart,and Etc). 
<br>
...
```bash
git clone https://github.com/M4rgs/MargBot-V4.git
cd MargBot-V4
```

2. Run:
```bash
python3 margus.py <list.txt>        # Start the exploit
python3 margus.py Dork              # GRab list from dorks
```
#### Features :
[+] Wordpress :
<pre>
